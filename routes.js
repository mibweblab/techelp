...
//   // we’ll need to convert each object returned by our fetchRequest function in dbOperations into feature objects. The properties field can hold optional meta-data like status, requestTime, address etc. You’ll write the handle in routes.js that will call the function, convert it to GeoJSON and then return it back:
